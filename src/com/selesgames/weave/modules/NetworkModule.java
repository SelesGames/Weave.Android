...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    MobilizerService provideMobilizerService(OkClient client, @ForJSON Converter converter) {
        RequestInterceptor interceptor = new RequestInterceptor() {
        ...
        RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint("http://mobilizer.cloudapp.net")
                .setClient(client).setConverter(converter).setLogLevel(LogLevel.FULL)
                .setRequestInterceptor(interceptor).build();
        return restAdapter.create(MobilizerService.class);
    }
